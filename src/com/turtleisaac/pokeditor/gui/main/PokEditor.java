...
public class PokEditor extends JDialog
{
    ...
    public static void main(String[] args)
    {
        ...
        else if (os.contains("win"))
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "You are running PokEditor by double clicking the jar file. You are required to run it from CMD with the following command:\n\"java -Dfile.encoding=UTF-8 -jar PokEditor-v2.jar\"\n.Continuing without running PokEditor v2 properly will result in the program not working.\nPlease go on GitHub and read the README for PokEditor v2 if you have not already.", "No Console Found", JOptionPane.ERROR_MESSAGE);
            }
        }
