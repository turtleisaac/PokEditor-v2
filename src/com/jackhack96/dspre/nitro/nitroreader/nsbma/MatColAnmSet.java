...
public class MatColAnmSet {
    ...
    private List<MatColAnm> matColAnimations;

    public MatColAnmSet(ByteReader data) {
        data.mark();
        ...
        matColAnimations = new ArrayList<>(entries.size());
        ...
        for (DictionaryEntry4byte entry : entries) {
            ...
            matColAnimations.add(new MatColAnm(data));
